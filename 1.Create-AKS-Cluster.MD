...
4. Once your cloud shell is started, clone the workshop repo into the cloud shell environment
    ```
    https://github.com/amalik99/AzureKubernetesService-Workshop.git
    ```
...
7. Find your RG name if you want to use existing rg. Use     ```az group create --name testrg -l westus2    ``` if you want to create a new RG.
    ...
    # copy the name from the results above and set to a variable. Create a new resource group if you don't want to use an exisitng RG
